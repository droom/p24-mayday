...
;;$(document).ready(function() {
  ...
  },
  {
    ...
    "year"     : "2012",
    "desc"     : "Design & build for numerous Flash OLA sets in standard formats. Clients include 4AD/Rough Trade (M. Ward, Discovery, Super Furry Animals, Jack Penate, Jarvis Cocker, The XX). I was given creative freedom with all listed."
  },
  {
    "project"  : "Standard format Rich OLA",
    "client"   : "Rough Trade",
  ...
  },
  {
    ...
    "role"     : "Design (UX, UI), Build (HTML, CSS, jQuery)",
    "year"     : "2014",
    "desc"     : ""
  },
  {
    ...
    "client"   : "Clarks",
    "role"     : "Design (UI, Flash), Motion (After Effect)",
    "year"     : "2012",
  ...
  },
  {
    ...
    "client"   : "LGN",
    "role"     : "Design (Concept), Motion (After Effect)",
    "year"     : "2011",
  ...
  },
  {
    "project"  : "GR Web App",
    "client"   : "GiveReceipt",
    "role"     : "Design (Identity, UX, UI, Print)",
    "year"     : "2014",
    "desc"     : ""
  },
  {
  ...
  var way_header_down = new Waypoint({element: document.getElementById('header'), handler: function(){
    $("#caption").css('opacity', '0');
    $("#continue").css('opacity', '1');
  }, offset: '-30%'});

  var way_header_up = new Waypoint({ element: document.getElementById('header'),handler:function(){
    $("#caption").css('opacity', '1');
    $("#continue").css('opacity', '0');
  }, offset: '-34%'});

  var way_footer_down = new Waypoint({element: document.getElementById('footer'), handler: function(){
    $("#caption").css('opacity', '0');
  }, offset: 0});
  var way_footer_up = new Waypoint({ element: document.getElementById('footer'),handler:function(){
    $("#caption").css('opacity', '1');
  }, offset: vh});
